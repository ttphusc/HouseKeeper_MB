...
class CleaningServiceScreen extends StatefulWidget {
  ...
  const CleaningServiceScreen({Key? key, required this.serviceId})
      : super(key: key);
...
class _CleaningServiceScreenState extends State<CleaningServiceScreen> {
  ...
  List<Map<String, dynamic>> _areaSizes = [
        ...
        children: _propertyTypes.map((type) {
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              height: 70,
              decoration: BoxDecoration(
                color: isSelected ? Color(0xFFE0F7E9) : Colors.grey.shade100,
                shape: BoxShape.circle,
                border: Border.all(
                  color: isSelected ? Color(0xFF28A745) : Colors.transparent,
                  width: 2,
                ),
              ),
              child: Column(
                ...
                children: [
                  Icon(
                    type['icon'],
                    color:
                        isSelected ? Color(0xFF28A745) : Colors.grey.shade700,
                    size: 24,
                  ),
                  SizedBox(height: 4),
                  Text(
